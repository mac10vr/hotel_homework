...
def answer_yes(yes)
  puts "#{yes}"" Ok. What type of room would you like?"
end
 ...
 #  class Guest
 # def initialize (single_room, double_room, rates)
...
# We're going to need to model individual hotels, and their rooms -- they can have single or double-rooms. The hotel should be able to tell us it's capacity.
